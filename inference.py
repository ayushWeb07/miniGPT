...
from train import GPT_CONFIG_124M, DEVICE, PIN_MEMORY, best_model_params_path
import tiktoken

# get the model outputs
def get_model_outputs(inputs: torch.Tensor, model: GPT, max_new_tokens_generated: int, config):
...
if __name__ == "__main__":
    ...
    y = get_model_outputs(x, model, 200, GPT_CONFIG_124M)
