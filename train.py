...
from dataset import get_dataloader, raw_data
...
learning_rate = 1e-4 
max_iters = 20000 # no of total epochs
warmup_steps = 1000 # increase LR for these many warmup epochs
min_lr = 5e-4 # min lr to reach while cosine annhealing
wd= 1e-3
batch_size= 32
...
small_subset= raw_data[:10000]
train_split= int(0.8 * len(small_subset))
train_data= small_subset[:train_split]
valid_data= small_subset[train_split: ]
